...
#ifndef CXA_AWCU300_MAX_NUM_TCP_CLIENTS
	#define CXA_AWCU300_MAX_NUM_TCP_CLIENTS		1
#endif

#ifndef CXA_AWCU300_MAX_NUM_TCP_SERVERS
	#define CXA_AWCU300_MAX_NUM_TCP_SERVERS		0
#else
...
#if CXA_AWCU300_MAX_NUM_TCP_CLIENTS > 0
static tcpClient_entry_t tcpClientMap[CXA_AWCU300_MAX_NUM_TCP_CLIENTS];
#endif
